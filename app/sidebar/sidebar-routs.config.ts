...
{ path: 'tables/bootstrap-table', title: 'Bootstrap Table', menuType: MenuType.LEFT, icon:'pe-7s-news-paper' },
...
{ path: 'maps/vector', title: 'Vector Maps', menuType: MenuType.LEFT, icon:'pe-7s-map-marker' },
{ path: 'maps/fullscreen', title: 'Full Screen Map', menuType: MenuType.LEFT, icon:'pe-7s-map-marker' },

{ path: 'charts', title: 'Charts', menuType: MenuType.LEFT, icon:'pe-7s-graph1' },

{ path: 'calendar', title: 'Calendar', menuType: MenuType.LEFT, icon:'pe-7s-date' },

{ path: 'pages/user', title: 'User Page', menuType: MenuType.LEFT, icon:'pe-7s-map-marker' },
{ path: '**', title: 'More Coming Soon', menuType: MenuType.LEFT, icon:'pe-7s-map-marker' },
